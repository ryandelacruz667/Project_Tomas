...
function categories_Numberofpeopleat24meters_12(
    feature,
    value,
    size,
    resolution,
    ...
    switch (valueStr) {
        ...
        case 'medium':
            return [new ol.style.Style({
                stroke: new ol.style.Stroke({ color: 'rgba(35,35,35,1.0)', lineDash: null, lineCap: 'butt', lineJoin: 'miter', width: 0.988 }),
                fill: new ol.style.Fill({ color: 'rgba(254,178,76,1.0)' }),
                text: createTextStyle(feature, resolution, labelText, labelFont, labelFill, placement, bufferColor, bufferWidth)
            })];
        case 'low':
            return [new ol.style.Style({
...
var style_Numberofpeopleat24meters_12 = function (feature, resolution) {
    ...
    var style = categories_Numberofpeopleat24meters_12(
        feature,
        value,
        size,
        resolution,
